...
//            model.addAttribute("people", personDAO.index());
    ...
    // если книга свободна, должны показывать выпадающий список из людей, чтобы с помощью select'а мы могли назначить эту книгу человеку
    @GetMapping("/{id}")
...
//        }
    ...
    // этот метод получает id книги И этой книги он убирает владелца (null)
    // у книги в БД в колонке во внешнем ключе будет назначено null
//    @PatchMapping("/{id}/release")
//    public String release(@PathVariable("id") int id) {
//        bookDAO.release(id);
//        return "redirect:/books/" + id;  // здесь простой redirect обратно на страницу с id
//    }
//
